...
/// <summary>
/// 매 프레임 Soma의 스킨드 메시 렌더러 위에 방패 메시를 동적으로 생성하며, 법선 방향 팽창과 주기적 아이들 히트 이펙트를 적용합니다.
/// </summary>
...
// 항상 이펙트 재생 여부
    ...
    [Range(0.1f, 3.0f)]
    public float idleInterval = 1.0f;  // 이펙트 트리거 간격
