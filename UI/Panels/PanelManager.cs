...
public class PanelManager : MonoBehaviour
{
    ...
    void OnDestroy()
    {
        if (_panelLeftAction != null)  _panelLeftAction.performed  -= OnPanelLeft;
        if (_panelRightAction != null) _panelRightAction.performed -= OnPanelRight;
    }

    public void SetPanelActions(InputAction panelLeft, InputAction panelRight)
    {
        if (_panelLeftAction != null)  _panelLeftAction.performed  -= OnPanelLeft;
        if (_panelRightAction != null) _panelRightAction.performed -= OnPanelRight;

        _panelLeftAction  = panelLeft;
        _panelRightAction = panelRight;
    ...
    private void OnPanelLeft(InputAction.CallbackContext ctx) => GoToPrevious();
    private void OnPanelRight(InputAction.CallbackContext ctx) => GoToNext();
