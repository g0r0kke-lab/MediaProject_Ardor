...
public class SaveData
{
    ...
    public bool hasCompletedMap2 = false;
...
// ============================================
/// <summary>
/// AES 암호화(배포) 또는 평문(에디터) JSON 파일로 맵 진행도, 세이브 포인트, 아이템 수집 정보를 저장·관리하는 싱글톤입니다.
/// </summary>
public class SaveDataManager : MonoBehaviour
{
    ...
    private bool _isDevTeleporting = false;
    ...
    public void SetComingFromIntro(bool value) => _isComingFromIntro = value;
    public bool IsComingFromIntro() => _isComingFromIntro;

    public void SetDevTeleporting(bool value) => _isDevTeleporting = value;
    public bool IsDevTeleporting() => _isDevTeleporting;
    ...
    // 맵2 완료 플래그 설정
    public void SetMap2Completed(bool completed)
    {
        _currentSaveData.hasCompletedMap2 = completed;
        SaveGameData();
        DebugLogger.Log($"맵2 완료 플래그 설정: {completed}");
    }

    // 맵2 완료 여부 확인
    public bool HasCompletedMap2()
    {
        return _currentSaveData.hasCompletedMap2;
    }
    ...
    public void ResetGameData()
    {
        ...
        bool wasMap2Completed = _currentSaveData.hasCompletedMap2;

        _currentSaveData = new SaveData();

        // 맵 완료 기록은 복원
        _currentSaveData.hasCompletedMap1 = wasMap1Completed;
        _currentSaveData.hasCompletedMap2 = wasMap2Completed;
